...
public class UserController {
    ...
    public ResponseEntity<String> deleteUser(@PathVariable String userId) {
        ...
        userService.deleteUserByUserId(Integer.valueOf(userId));
    ...
    private JSONObject validateUserRequest(String userData) {
        ...
        if (userJson.has("password")) {
            ...
            if (!CommonUtils.isValidPassword(password)) {
                errorList.put("password", "Please enter valid password eg: Sankalp@123");
            }
        } else {
            errorList.put("password", "Missing parameter");
        }
        ...
        if (userJson.has("email")) {
            ...
            if (!CommonUtils.isValidEmail(email)) {
                errorList.put("email", "Please enter a valid email eg: created@xyz.co");
            }
        } else {
